...
| --------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 21AB      | Provides code execution capabilities, including:<br><br>Load ELF in memory using its own statically linked copy of the custom ELF loader library and invoke a symbol by name<br>Execute an arbitrary shell command using /bin/sh                                                                                                                                                                                                                                                                                                                                                                                                                                             |
